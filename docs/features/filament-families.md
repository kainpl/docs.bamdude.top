...
A **filament you created** (Bambu Studio's *Create filament*, synced from your Bambu Cloud) has no catalog presets — its presets are yours, one per printer you made it for. The slot gets the one made for that printer and nozzle, with its temperatures: your "… @Bambu Lab P1S 0.4 nozzle" on a P1S, your "… @Bambu Lab X2D 0.4 nozzle" on an X2D. Which printer a preset is for is read from the preset it was based on, or from the "@" part of its name; of two for the same printer, the one saved last wins. Where you made none for that printer or nozzle, the slot gets the family and your temperatures without a preset name.
