...
- **Корзина бібліотеки** — для файлів, які ти завантажив або сляйснув у бібліотеку.
- **Корзина архіву** — для рядків print archive, які auto-purge виносить з активної історії.

Обидві корзини одного крою: soft-delete на ручне видалення, конфігурований restore-window, scheduled-retention sweeper, і chain-of-custody guard, що відмовляється hard-delete'ити байти бібліотеки, якщо на них ще посилається активний архів.
