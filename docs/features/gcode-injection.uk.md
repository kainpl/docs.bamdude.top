...
- **Slice-time injection** — sidecar [Slicer API](slicer-api.md) може застосувати ті самі сніпети у час слайсингу для STL-джерела. Тоглер той самий.
...
- [Slicer API](slicer-api.md) — slice-time інжекція для STL → 3MF.
