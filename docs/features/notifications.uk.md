...
| `print_progress` | На 25% / 50% / 75% прогресу. Глобальне налаштування **мінімальної тривалості** (Налаштування → Сповіщення) глушить їх для друків, коротших за N хвилин — тривалість оцінюється із власного remaining-time принтера на кожному milestone, а невідома оцінка шле, а не вгадує. `0` (типово) — слати завжди. Поріг **каскадний**: кожен чат Telegram має власне значення (біля чекбокса «Проміжний прогрес» у налаштуваннях чату), кожен інший провайдер — своє (на його картці, біля того ж тогла); порожнє значення на будь-якому рівні успадковує глобальне, `0` = слати завжди. |
