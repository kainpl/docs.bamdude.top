...
| `print_progress` | На 25% / 50% / 75% прогресу. Глобальне налаштування **мінімальної тривалості** (Налаштування → Сповіщення) глушить їх для друків, коротших за N хвилин — тривалість оцінюється із власного remaining-time принтера на кожному milestone, а невідома оцінка шле, а не вгадує. `0` (типово) — слати завжди. Чати Telegram мають **власний** поріг — редагується біля чекбокса «Проміжний прогрес» у налаштуваннях чату (порожньо = успадкувати глобальний, `0` = завжди); решта каналів слідують глобальному. |
