...
| Пікер сімей у слоті AMS | Кастомні Orca-філаменти — повноцінні [сім'ї](filament-families.uk.md), віддзеркалені на сервер у каталог сімей поряд із Bambu Cloud, з бейджем; принтер отримує ідентифікатор сім'ї, або системну сім'ю того ж типу філаменту на принтерах без підтримки користувацьких пресетів |
