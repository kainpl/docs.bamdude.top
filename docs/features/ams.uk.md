...
3. Оберіть пресет філаменту (фільтрується за моделлю принтера **і за реально
   встановленим соплом**)
4. Оберіть відповідний K-профіль
5. За бажанням встановіть власний колір

Picker фільтрує за **реально встановленим діаметром сопла**, а не фіксованими
0.4 мм. З соплом 0.6 мм ти побачиш профілі на 0.6 мм для своїх лотків; на
двосопловому H2D кожен AMS показує профілі того сопла, яке його живить.
Налаштування слота профілем, що не відповідає встановленому соплу, — саме те, від
чого принтер відхиляє друк із загадковим *«Failed to get AMS mapping table»*.
Тепер черга ловить цю розбіжність **до** завантаження й завалює завдання
