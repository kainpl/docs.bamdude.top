...
**Увесь друк на одному вході:** коли всі філаменти друку стоять за одним входом, діалог друку про це каже. Це дозволено, але повільно — зміна між двома філаментами на одному вході тягне стару котушку аж до її AMS, перш ніж наступна піде спільною трубкою; між двома входами — лише до перемикача. Досить перенести одну котушку в AMS на іншому вході. Це порада, не заборона.
