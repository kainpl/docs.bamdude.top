...
!!! tip "Слайсь-і-в-чергу одним кліком, і спершу прогрій стіл"
    Дві супутні функції стоять поруч із чергою: [Slicer Pipelines](slicer-pipelines.md) зберігають налаштування слайсу, щоб підставити всі чотири пресети в діалог Slice одним вибором, а [Прогрів і heat-soak](preheat.md) тримає стіл (і, де підтримується, камеру) на температурі перед стартом друку інженерним філаментом.
