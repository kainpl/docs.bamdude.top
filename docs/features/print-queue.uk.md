...
**Prefer lowest remaining filament** (`prefer_lowest_filament`, налаштування ферми, типово вимкнене): коли auto-matcher має кілька кандидатів-слотів під один філамент, BamDude бере слот з **найменшим залишком (g)** — догризати майже-порожні бабіни, замість завжди слот 1.
