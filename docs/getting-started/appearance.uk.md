...
## :material-tab: Прогрес друку у вкладці браузера

**Типово вимкнено.** Увімкни **Show print progress in the browser tab** — і заголовок вкладки нестиме відсоток друку, який завершиться найшвидше, а іконка вкладки стане кільцем прогресу в кольорі твого акценту.

Вікно браузера, залишене на іншому екрані, тоді саме розповідає, як справи на фермі, — не треба туди перемикатися. Корисно на настінному екрані й радше зайве на ноуті, у якому ти працюєш. Тому це налаштування **на браузер**, а не на акаунт, як і все інше на цій сторінці.

Вимкнення повертає вкладку рівно в той вигляд, який був.
